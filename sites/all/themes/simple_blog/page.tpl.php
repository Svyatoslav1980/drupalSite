...
if($node->type == 'webform'){
  $background = $node->field_contact_header['und'][0]['filename'];
  $subheader = $node->field_contact_subheader['und'][0]['value'];
} else {
  $background = $node->field_background_image['und'][0]['filename'];
  $subheader = $node->field_subheader['und'][0]['value'];
}
?>

  <!-- Page Header -->
  <header class="masthead" style="background-image:url('../sites/default/files/<?php print $background; ?>')">
